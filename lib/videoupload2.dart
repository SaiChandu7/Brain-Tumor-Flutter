...
class _VideoPickerWidgetState extends State<VideoPickerWidget> {
  ...
  Future<Map<String, dynamic>> sendVideo(File video) async {
    var request = http.MultipartRequest('POST',
        Uri.parse('http://3.110.210.44/vpredict')
    ...
    return Column(
      children: <Widget>[
        ElevatedButton(
          ...
          child: Text('Pick Video',style: TextStyle(color: Colors.black87,fontSize: 20),),
        ),
...
class _MyHome1State extends State<MyHome1> {
  ...
  Future<Map<String, dynamic>> sendVideo(File video) async {
    var request = http.MultipartRequest(
        'POST', Uri.parse('http://3.110.210.44/vpredict'));
    request.files.add(await http.MultipartFile.fromPath('video', video.path));
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color(0xFFC0B7FF),
          title: Text('Brain Hemorrhage Classifier',style: TextStyle(color: Colors.black87),),
          centerTitle: true,
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text('Predict',style: TextStyle(color: Colors.black87,fontSize: 20),),
                ),
                SizedBox(height: 20),
                if (_selectedVideo != null &&
                    _chewieController != null &&
